...
public class mailService {
   ...
   private String apiKey;
    ...
    public void sentVerifyOtp(String username,String email,String otp) throws MessagingException {
        ...
        sendSmtpEmail.setSender(new SendSmtpEmailSender().name("resume analyze").email("deepakdeore5650@gmail.com"));
        ...
        try{
            ...
            System.out.println("Brevo ApiException sending verification email: code=" + e.getCode() + ", message=" + e.getMessage());
            System.out.println("Brevo response body: " + e.getResponseBody());
            throw new RuntimeException("Brevo ApiException: " + e.getMessage(), e);
        }
    ...
    public void sentResetOtp(String username,String email,String otp) throws MessagingException {
        ...
        SendSmtpEmail sendSmtpEmail = new SendSmtpEmail();
        sendSmtpEmail.setSender(new SendSmtpEmailSender().name("Resume Analyser").email("deepakdeore5650@gmail.com"));
        sendSmtpEmail.setTo(Collections.singletonList(new SendSmtpEmailTo().name(username).email(email)));
        ...
        try{
            ...
            System.out.println("Brevo ApiException sending reset OTP email: code=" + e.getCode() + ", message=" + e.getMessage());
            System.out.println("Brevo response body: " + e.getResponseBody());
            throw new RuntimeException("Brevo ApiException: " + e.getMessage(), e);
        }
